...
var _MainContainer = __webpack_require__(34);
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(1),m=__webpack_require__(14),p=__webpack_require__(4),v=__webpack_require__(3),da=__webpack_require__(15),ea=__webpack_require__(16),fa=__webpack_require__(17),ha=__webpack_require__(6);
...
var _NavigationContainer = __webpack_require__(35);

var _NavigationContainer2 = _interopRequireDefault(_NavigationContainer);

var _HomeComponent = __webpack_require__(51);

var _HomeComponent2 = _interopRequireDefault(_HomeComponent);

var _AboutComponent = __webpack_require__(52);

var _AboutComponent2 = _interopRequireDefault(_AboutComponent);

var _ProjectBoardComponent = __webpack_require__(53);

var _ProjectBoardComponent2 = _interopRequireDefault(_ProjectBoardComponent);

var _BlogContainer = __webpack_require__(55);
	...
	_createClass(MainContainer, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'container' },
				_react2.default.createElement(_NavigationContainer2.default, { page: this.state.page,
					toHome: this.toHome,
				...
				_react2.default.createElement(_HomeComponent2.default, { page: this.state.page,
					toAbout: this.toAbout,
					toProjects: this.toProjects,
					toBlog: this.toBlog,
					display: this.state.page == 'home' ? 'flex' : 'none' }),
				_react2.default.createElement(_AboutComponent2.default, { page: this.state.page,
					display: this.state.page == 'about' ? 'flex' : 'none' }),
				_react2.default.createElement(_ProjectBoardComponent2.default, { page: this.state.page,
					display: this.state.page == 'projects' ? 'flex' : 'none' }),
				_react2.default.createElement(_BlogContainer2.default, { page: this.state.page,
...
var NavigationContainer = function (_React$Component) {
	...
	function NavigationContainer(props) {
		...
		return _possibleConstructorReturn(this, (NavigationContainer.__proto__ || Object.getPrototypeOf(NavigationContainer)).call(this, props));
	}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ key: this.props.show, className: 'nav-bar', style: { display: this.props.display } },
						_react2.default.createElement(
							'div',
							{ className: 'name' },
							_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'li',
								{ onClick: this.props.toProjects },
								'PROJECTS'
							),
							_react2.default.createElement(
								'li',
								{ onClick: this.props.toBlog },
								'BLOG'
							)
						)
					)
...
var _TransitionGroup = __webpack_require__(41);

var _TransitionGroup2 = _interopRequireDefault(_TransitionGroup);

var _CSSTransitionGroupChild = __webpack_require__(45);
...
var _chainFunction = __webpack_require__(42);
...
var _requestAnimationFrame = __webpack_require__(49);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'titleContainer', key: this.props.page, style: { display: this.props.display } },
						_react2.default.createElement(
							'div',
							{ className: 'banner' },
							_react2.default.createElement(
						...
						_react2.default.createElement('img', { className: 'jelly', src: 'jelly.png' })
					)
				)
			);
		}
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								null,
								'I\'m a first-year student at the University of Waterloo studying computer science. Here you\'ll find my professional resume, my portfolio, and a personal blog.',
								_react2.default.createElement('br', null),
								' ',
								_react2.default.createElement('br', null),
						...
						_react2.default.createElement('img', { className: 'head', src: 'head.png' })
					)
				)
			);
		}
...
var _ProjectComponent = __webpack_require__(54);
...
var ProjectBoardComponent = function (_React$Component) {
	_inherits(ProjectBoardComponent, _React$Component);

	function ProjectBoardComponent(props) {
		_classCallCheck(this, ProjectBoardComponent);

		return _possibleConstructorReturn(this, (ProjectBoardComponent.__proto__ || Object.getPrototypeOf(ProjectBoardComponent)).call(this, props));
	}

	_createClass(ProjectBoardComponent, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				_reactAddonsCssTransitionGroup2.default,
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'projects-row', style: { paddingBottom: 50 } },
							_react2.default.createElement(_ProjectComponent2.default, { className: 'square',
...
exports.default = ProjectBoardComponent;
...
var ProjectComponent = function (_React$Component) {
	...
	function ProjectComponent(props) {
		...
		return _possibleConstructorReturn(this, (ProjectComponent.__proto__ || Object.getPrototypeOf(ProjectComponent)).call(this, props));
	}
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('img', { className: 'project-preview', src: this.props.image }),
						_react2.default.createElement(
							'div',
							{ className: 'overlay' },
							_react2.default.createElement(
...
var _PostPreviewComponent = __webpack_require__(56);

var _PostPreviewComponent2 = _interopRequireDefault(_PostPreviewComponent);
...
var BlogContainer = function (_React$Component) {
	...
	function BlogContainer(props) {
		...
		_this.prevPage = function (e) {
			if (_this.state.currentpage != 0) {
				var pagenum = _this.state.currentpage;
				_this.setState({ currentpage: pagenum - 3 });
			}
		};

		_this.nextPage = function (e) {
			if (_this.state.currentpage != _this.maxPage) {
				var pagenum = _this.state.currentpage;
				_this.setState({ currentpage: pagenum + 3 });
			}
		};
	...
	_createClass(BlogContainer, [{
		key: 'render',
		value: function render() {
			var titleArray = ["Reflections on ClassWatch", "Debate and Public Speaking", "Reflections on My Personal Site", "Reflections on Chroma", "A Blog's Purpose", "FILLER6"];
			var dateArray = ["08/01/2018", "01/24/2018", "01/10/2018", "12/26/2017", "12/03/2017", "00/00/00"];
			var previewArray = ["This summer, a fellow Waterloo student and I launched ClassWatch, a web application made specifically for UW students to help with course...", "I debated competitively through all four years of high school. By competitive, I mean practices and coaches and tournaments. I was in...", "I'm writing this after having re-designed my site twice, with a third time in the works. That should give you a pretty good idea of how much...", "When I decided I wanted to make a mobile game, all the programming knowledge I had came from a month of self-taught Java fundamentals and two...", "Welcome all to the first post of my blog. I'm writing this as a short introduction for (hopefully) many other posts to come. As of now, the plan is...", "Lorem ipsum dolor sit amet, sea idque virtute cu. Delectus facilisi facilisis per ei, duo ea suas tempor inermis. Eos omnis instructior id. Nec..."];
			var linkArray = ["dist/posts/classwatch.html", "dist/posts/speaking.html", "dist/posts/website.html", "dist/posts/chroma.html", "dist/posts/intro.html", "#"];
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'button' },
							_react2.default.createElement('i', { style: { color: this.state.currentpage == 0 ? '#FFFFFF' : null, visibility: this.state.currentpage == 0 ? 'hidden' : 'visible' },
								className: 'fas fa-caret-left', onClick: this.prevPage })
						),
						_react2.default.createElement(
							'div',
							{ className: 'previews' },
							_react2.default.createElement(_PostPreviewComponent2.default, { title: titleArray[this.state.currentpage],
							...
							_react2.default.createElement(_PostPreviewComponent2.default, { title: titleArray[this.state.currentpage + 1],
							...
							_react2.default.createElement(_PostPreviewComponent2.default, { title: titleArray[this.state.currentpage + 2],
						...
						_react2.default.createElement(
							'div',
							{ className: 'button' },
							_react2.default.createElement('i', { style: { color: this.state.currentpage == this.maxPage ? '#FFFFFF' : null, visibility: this.state.currentpage == this.maxPage ? 'hidden' : 'visible' },
								className: 'fas fa-caret-right', onClick: this.nextPage })
						)
					)
				)
			);
...
var PostPreviewComponent = function (_React$Component) {
	_inherits(PostPreviewComponent, _React$Component);

	function PostPreviewComponent(props) {
		_classCallCheck(this, PostPreviewComponent);

		return _possibleConstructorReturn(this, (PostPreviewComponent.__proto__ || Object.getPrototypeOf(PostPreviewComponent)).call(this, props));
	}
...
exports.default = PostPreviewComponent;
